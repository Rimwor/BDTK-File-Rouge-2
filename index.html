...
<body>
    ...
    <body background="ASSETS/MEDIA/bdthequebackground.jpg" alt="background">
        ...
        <div class="container-fluid">
            ...
            <!-- CONNECTION FORM -->
            <div class="container-md align-self-auto bg-secondary p-5-md mt-10-md mt-15-sm mt-15-fs bg-opacity-85 border">
                
                <div class="mb-8 mt-3 fs-4 text-center">
                    <h1 class="bienvenue">Bienvenue</h1>
                    <img src="ASSETS\MEDIA\line.png" class="line" alt="line" />
                </div>
